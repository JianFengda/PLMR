...
def load_fashionmnist(partial_rate, batch_size):
    raw_folder = 'raw'
    processed_folder = 'processed'
    training_file = 'training.pt'
    test_file = 'test.pt'

    train_data, train_labels = torch.load(os.path.join('./data/fashionmnist/',processed_folder,training_file))
    train_data = train_data.numpy()

    test_data, test_labels = torch.load(os.path.join('./data/fashionmnist/', processed_folder,test_file))
    ...
    partial_matrix_dataset = FMNIST_Augmentation(train_data, partialY.float(), train_labels.float())
...
class FMNIST_Augmentation(Dataset):
