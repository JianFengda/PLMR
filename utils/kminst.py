...
def load_kmnist(partial_rate, batch_size):
    raw_folder = 'raw'
    processed_folder = 'processed'
    training_file = 'training.pt'
    test_file = 'test.pt'

    train_data, train_labels = torch.load(os.path.join('./data/kmnist/',processed_folder,training_file))
    train_data = train_data.numpy()

    test_data, test_labels = torch.load(os.path.join('./data/kmnist/', processed_folder,test_file))
    ...
    partial_matrix_dataset = KMNIST_Augmentation(train_data, partialY.float(), train_labels.float())
...
class KMNIST_Augmentation(Dataset):
